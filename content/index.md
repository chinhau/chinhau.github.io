...
<p class="tagline"><em>
  ...
  This logbook documents the e³ (explore, evaluate, exploit) feedback loop that makes convergence possible — aligning intention with outcomes through tight iterations.
